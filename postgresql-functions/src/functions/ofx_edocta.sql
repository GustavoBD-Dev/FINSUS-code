CREATE OR REPLACE FUNCTION ofx_edoctaconv(INTEGER, INTEGER, INTEGER, DATE, DATE)
...
BEGIN
  ...
  ps_idsucaux               := ($1);--of_param_sesion_get('vsr_vars','ps_idsucaux');
  ps_idproducto             := ($2);--of_param_sesion_get('vsr_vars','ps_idproducto');
  ps_idauxiliar             := ($3);--of_param_sesion_get('vsr_vars','ps_idauxiliar');
  t.fechreal                := current_date;
  t.fechoperacion           := current_date;--of_param_sesion_get('global','fecha')::DATE;
  ps_afecha                 := ($4);--of_param_sesion_get('vsr_vars','ps_afecha');
  ps_dfecha                 := ($5);--of_param_sesion_get('vsr_vars','ps_dfecha');
